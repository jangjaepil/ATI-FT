...
void bias_switchCallback(const std_msgs::Bool & msg)
{
   bias_switch = msg.data;
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber bias_switch_sub = nh.subscribe("/hrii/bias_switch", 20, bias_switchCallback);
...
//   atiMaster = new Ati_Sens("192.168.0.50", true);    // NANO-17
  ...
  // Remove bias
  std::size_t num_points; num_points  = 500;
...
//   sensdata_bias.setZero(6);
  ...
  while (ros::ok())
  {
    ...
    wrench.wrench.torque.z = sample.ft[5];
      ...
      msg_wrench.wrench.force.x = (wrench.wrench.force.x )/1000;
      msg_wrench.wrench.force.y = (wrench.wrench.force.y )/1000;
      msg_wrench.wrench.force.z = (wrench.wrench.force.z )/1000;

      msg_wrench.wrench.torque.x = (wrench.wrench.torque.x )/1000;
      msg_wrench.wrench.torque.y = (wrench.wrench.torque.y )/1000;
      msg_wrench.wrench.torque.z = (wrench.wrench.torque.z )/1000;
...
//         ROS_INFO_STREAM("T: " << torque_b);
     ...
     { 
      ...
      if(bias_status.data){
		  ...
		  msg_wrench.header.frame_id = "ATI-AXIA-80";
        ati_wrench_pub.publish(msg_wrench);
